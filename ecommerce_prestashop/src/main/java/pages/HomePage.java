...
public class HomePage {
	...
	private By textoProdutoNoCarrinho = By.className("cart-products-count");
	...
	public int obterQuantidadeProdutosNoCarrinho() {
		...
		String quantidadeProdutosNoCarrinho = driver.findElement(textoProdutoNoCarrinho).getText();

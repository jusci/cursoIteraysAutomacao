...
public class HomePageTests extends BaseTests {
	...
	public void testLoginComSucesso_UsuarioLogado() {
		...
		// Validar se usuário esta logado de fato
	...
	@CsvFileSource(resources="/massaTeste_Login.csv", numLinesToSkip = 1,delimiter =';') // pula a primeira linha do cabeçalho
	...
	public void incluirProdutoNoCarrinho_ProdutoIncluidoComSucesso() {
		...
		// verifica se traz a opção selecionada e o tamanho da lista
	...
	public void finalizarPedido_pedidoFinalizadoComSucesso() {
		...
		// Teste
		// Clicar botão para confirmar pedido
